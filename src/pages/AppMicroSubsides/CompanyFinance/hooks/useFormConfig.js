...
import { getAccount, isComplete } from '@/services/microSubsidy/companyFinance'
...
export const usePersonAssetsConfig = (form, id, initialValue = {}) => {
  ...
  return [
    ...
    //资产证明
    {
      ...
      name: renderConfigName('propertyCertificateFiles'),
      validateTrigger: 'onChange',
      rules: [{ required: true, message: '加盖公章的个人资产证明' }, { validator: validateFiles }],
      children: (
        <Upload
          {...getUploadProps('加盖公章的房产证明', true)}
          accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
        />
      )
    },
...
// 融资信息
export const useFinanceConfig = (form, companyDetail) => {
  // debugger
  // console.log("fetchCompanyDetailReq",fetchCompanyDetailReq)
  ...
  // 请求企业信息-完善度-是否必填
  const { data: cmpDetail = {}, loading, start: fetchCompanyDetailReq } = useRequest(isComplete, {
    manual: true
  })
  ...
  // 获取银行账号列表
  const { data: bankAccountList = [], start: fecthBankAccountListReq } = useRequest(getAccount, {
    manual: true
  })
  ...
  useEffect(() => {
    fecthBankAccountListReq({ orgName: orgName })
  }, [orgName, fecthBankAccountListReq])
  ...
  return [
    ...
    // 预计还款日
    {
      ...
      name: 'paymentDate',
      rules: [{ required: true, message: '请选择预计还款日' }],
    ...
    },
    {
      ...
      children: (
        // <Select placeholder="请选择" {...bankProps}>
        //   {bankList.map((i) => (
    ...
    {
      id: 'damn', // id作为key
      itemProps: { label: '开户省市', required: true },
      ...
      children: [
        {
          ...
          children: (
            // <Select {...provinceProps} placeholder="请选择省份">
            //   {provinceList.map((p) => (
        ...
        },
        {
          ...
          children: (
            // <Select {...cityProps} placeholder="请选择城市">
            //   {cityList.map((c) => (
    ...
    },
    {
      ...
      name: 'bankBranch',
      children: (
        // <Select {...branchProps} placeholder="请选择所属支行">
        //   {branchList.map((i) => (
    ...
    //     extra: (
    //       <span>
    //         忘记支行名称？请<a onClick={() => toggleManual()}>自行选择</a>
    //       </span>
    //     )
    //   },
    //   condition: {
    ...
    },
    {
      ...
      children: (
        <SupplyRelationCard
          data={cmpDetail}
          type="cmp"
          url={cmpDetail.orgId ? `/msUserCenter/companyInfo/edit/${cmpDetail.orgId}` : ''}
        ...
        //       <div style={{ width: 60, fontSize: 14, color: 'rgba(0,0,0,0.45)', marginRight: 5 }}>
        //         供应商
        //       </div>
        //       <div>
        //         <div style={{ fontSize: 14 }}>111</div>
        //         <div style={{ fontSize: 14 }}>222</div>
        //       </div>
        //     </div>
        //     <div style={{ display: 'flex' }}>
        //       <div style={{ width: 60, fontSize: 14, color: 'rgba(0,0,0,0.45)', marginRight: 5 }}>
    ...
    },
    {
      ...
      name: 'auditFiles',
      validateTrigger: 'onChange',
      rules: [{ required: true, message: '请上传审计报告/财务报表' }, { validator: validateFiles }],
      children: (
        // <Upload
        //   minLength="1"
        //   length="10"
        //   size="20"
        //   extra="请上传加盖公章的近两年审计报告及近期财务报表"
        //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
        //   listType="picture"
        // >
        //   <Button>
    ...
    // 带标题分割线
    {
      ...
      children: (
        // <div style={{ display: 'flex' }}>
        //   <div style={{ flex: 1, color: 'rgba(0, 0, 0, 0.45)', fontSize: 14, minWidth: 100 }}>
        //     对账单流水
        //   </div>
        //   <div
        //     style={{
    ...
    // 带标题分割线
    {
      ...
      children: (
        // <div style={{ display: 'flex' }}>
        //   <div style={{ flex: 1, color: 'rgba(0, 0, 0, 0.45)', fontSize: 14, minWidth: 50 }}>
        //     征信
        //   </div>
        //   <div
        //     style={{
    ...
    //   name: 'agreementFiles',
    //   validateTrigger: 'onChange',
    //   rules: [{ required: true, message: '请上传购销合同' }, { validator: validateFiles }],
    //   children: (
    //     // <Upload
    //     //   minLength="1"
    //     //   length="10"
    //     //   size="20"
    //     //   extra="请上传加盖公章的大额销售或采购合同复印件，并提供相应证明材料"
    //     //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
    //     //   listType="picture"
    //     // >
    //     //   <Button>
    ...
    //     // </Upload>
    //     <Upload
    //       {...getUploadProps('加盖公章的大额销售或采购合同复印件，并提供相应证明材料', true)}
    //       accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
    //     />
    //   )
    // },
    ...
    // {
    //   itemProps: { label: '产权证明', wrapperCol: { span: 14 } },
    //   name: 'ownerFiles',
    //   validateTrigger: 'onChange',
    //   rules: [{ validator: validateFiles }],
    //   children: (
    ...
    //     //   length="10"
    //     //   size="20"
    //     //   extra="请上传加盖公章的企业、法人/实控人及其配偶动产、不动产产权证明"
    //     //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
    //     //   listType="picture"
    //     // >
    //     //   <Button>
    ...
    //     // </Upload>
    //     <Upload
    //       {...getUploadProps('加盖公章的企业、法人/实控人及其配偶动产、不动产产权证明')}
    //       accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
    //     />
    //   )
    // },
    // {
    //   itemProps: { label: '抵押信息', wrapperCol: { span: 14 } },
    //   name: 'mortgageFiles',
    //   validateTrigger: 'onChange',
    //   rules: [{ validator: validateFiles }],
    //   children: (
    ...
    //     //   length="10"
    //     //   size="20"
    //     //   extra="请上传加盖公章的企业、法人/实控人及其配偶动产、不动产抵押信息"
    //     //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
    //     //   listType="picture"
    //     // >
    //     //   <Button>
    ...
    //     // </Upload>
    //     <Upload
    //       {...getUploadProps('加盖公章的企业、法人/实控人及其配偶动产、不动产抵押信息')}
    //       accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
    //     />
    //   )
    // },
    ...
    // {
    //   itemProps: { label: '其他融资材料', wrapperCol: { span: 14 } },
  ...
  return [
    ...
    //营业执照
    {
      ...
      children: (
        ...
        //   length="10"
        //   size="20"
        //   extra="请上传加盖公章的反担保企业营业执照正本、副本、开户许可证复印件"
        //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
        //   listType="picture"
        // >
        //   <Button>
    ...
    //审计报表
    {
      ...
      children: (
        ...
        //   length="10"
        //   size="20"
        //   extra="请上传加盖公章的反担保企业近两年审计报告及近期财务报表"
        //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
        //   listType="picture"
        // >
        //   <Button>
    ...
    },
    {
      ...
      children: (
        ...
        //   length="10"
        //   size="20"
        //   extra="请上传加盖公章的反担保企业法人/实际控制人及其配偶身份证、结婚证（离婚证或单身证明）、户口本复印件"
        //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
        //   listType="picture"
        // >
        //   <Button>
    ...
    },
    {
      ...
      children: (
        ...
        //   length="10"
        //   size="20"
        //   extra="请上传加盖公章的个人反担保的身份证、结婚证（离婚证或单身证明）、户口本复印件、个人征信报告 "
        //   accept="doc,docx,xls,xlsx,pdf,jpg,jpeg,png"
        //   listType="picture"
        // >
        //   <Button>
